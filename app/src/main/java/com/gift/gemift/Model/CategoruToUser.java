...
public class CategoruToUser implements Serializable {

    private int request_id;
    private String referred_user_id;
    private String friend_circle_id;
    private ArrayList<InterestList> list_category_id;
    ...
    public ArrayList<InterestList> getList_category_id() {
        return list_category_id;
    }

    public void setList_category_id(ArrayList<InterestList> list_category_id) {
