...
public class UpcomingEventsBelow14Adaptor extends RecyclerView.Adapter<UpcomingEventsBelow14Adaptor.ViewHolder> {
    ...
    public UpcomingEventsBelow14Adaptor(ArrayList<MyOccasionDataItems> occasionsModelArrayList, Context mcontext) {
    ...
    @NonNull
    @Override
    public UpcomingEventsBelow14Adaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UpcomingEventsBelow14Adaptor.ViewHolder(UpcomingEventsBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull UpcomingEventsBelow14Adaptor.ViewHolder holder, int position) {
        String lastName = "";
