...
public class UpcomingEventsAbove28Adaptor extends RecyclerView.Adapter<UpcomingEventsAbove28Adaptor.ViewHolder> {
    ...
    public UpcomingEventsAbove28Adaptor(ArrayList<MyOccasionDataItems> occasionsModelArrayList, Context mcontext) {
    ...
    @NonNull
    @Override
    public UpcomingEventsAbove28Adaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UpcomingEventsAbove28Adaptor.ViewHolder(UpcomingEventsBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull UpcomingEventsAbove28Adaptor.ViewHolder holder, int position) {
        String lastName = "";
