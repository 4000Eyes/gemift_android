...
public class UpcomingEventsAdaptor extends RecyclerView.Adapter<UpcomingEventsAdaptor.ViewHolder> {
    ...
    public UpcomingEventsAdaptor(ArrayList<MyOccasionDataItems> occasionsModelArrayList, Context mcontext) {
    ...
    @NonNull
    @Override
    public UpcomingEventsAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UpcomingEventsAdaptor.ViewHolder(UpcomingEventsBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull UpcomingEventsAdaptor.ViewHolder holder, int position) {
       ...
       holder.binding.txtOccasionName.setText(occasionsModelArrayList.get(position).getOccasionName());
        ...
        if(occasionsModelArrayList.get(position).getDaysLeft()>=29){
        ...
        }else if(occasionsModelArrayList.get(position).getDaysLeft()>=15){
